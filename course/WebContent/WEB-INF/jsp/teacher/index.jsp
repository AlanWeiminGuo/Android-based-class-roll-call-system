	...
	<div class="layui-side layui-bg-black">
		<div class="layui-side-scroll">
	      	<ul class="layui-nav layui-nav-tree"  lay-filter="test">
	      		<li class="layui-nav-item" data-biao-shi="item" data-item="${base}/course_list"><a href="javascript:;">课程管理</a></li>
	      		<li class="layui-nav-item" data-biao-shi="item" data-item="${base}/addcourse"><a href="javascript:;">添加课程</a></li>
	      	</ul>
    	</div>
	</div>
</div>
