...
public class TRegisterActivity extends BaseActivity {
    ...
    @OnClick({R.id.lin_back, R.id.tv_uppass, R.id.touxiang, R.id.new_sex, R.id.btn_up})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.lin_back:
                ...
                break;
            case R.id.tv_uppass:
                Intent intent = new Intent(TRegisterActivity.this,UpPwdActivity.class);
    ...
    protected void options() {
        ...
        mDialog.addSheetItem("拍照", ActionSheetDialog.SheetItemColor.Blue, new ActionSheetDialog.OnSheetItemClickListener() {
            ...
            public void onClick(int which) {
                PhotoUtil.photograph(TRegisterActivity.this);
            }
        }).addSheetItem("从相册选取", ActionSheetDialog.SheetItemColor.Blue, new ActionSheetDialog.OnSheetItemClickListener() {
            @Override
            public void onClick(int which) {
                PhotoUtil.selectPictureFromAlbum(TRegisterActivity.this);
            }
        }).show();
    }

    public void change_juese() {
        AlertDialog.Builder builder = new AlertDialog.Builder(TRegisterActivity.this); //定义一个AlertDialog
        String[] strarr = {"男", "女"};
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PhotoUtil.PHOTOGRAPH) {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                ...
                if (!picture.exists()) {
                    picture = new File(TRegisterActivity.this.getFilesDir() + PhotoUtil.imageName);
                }
            }
            ...
            PhotoUtil.startPhotoZoom(TRegisterActivity.this, Uri.fromFile(picture), PhotoUtil.PICTURE_HEIGHT, PhotoUtil.PICTURE_WIDTH, imageUri);
        }
        ...
        if (requestCode == PhotoUtil.PHOTOZOOM) {
            ...
            Uri imageUri = UriPathUtils.getUri(this, path);
            PhotoUtil.startPhotoZoom(TRegisterActivity.this, data.getData(), PhotoUtil.PICTURE_HEIGHT, PhotoUtil.PICTURE_WIDTH, imageUri);
        }
        // 处理结果
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String arg0, int arg1) {
                        ...
                        if (0 == baseData.getCode()) {
                            ...
                            Toast.makeText(TRegisterActivity.this, baseData.getMsg(), Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onError(Call arg0, Exception arg1, int arg2) {
                        Toast.makeText(TRegisterActivity.this, "网络错误", Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String arg0, int arg1) {
                        ...
                        if (0 == userEntity.getCode()) {
                            Static.head = head;
                            Toast.makeText(TRegisterActivity.this, "修改头像成功", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(TRegisterActivity.this, userEntity.getMsg(), Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void upinfo() {
        if (newRealname.getText().toString().trim().equals("")) {
            Toast.makeText(TRegisterActivity.this, "姓名不能为空!", Toast.LENGTH_LONG).show();
            return;
        }
        if (newPhone.getText().toString().trim().equals("")) {
            Toast.makeText(TRegisterActivity.this, "手机号码不能为空!", Toast.LENGTH_LONG).show();
            return;
        }
        if (AccountValidatorUtil.isMobile(newPhone.getText().toString().trim()) == false) {
            Toast.makeText(TRegisterActivity.this, "请输入正确的手机号码!", Toast.LENGTH_LONG).show();
            return;
        }
        if (newPassword.getText().toString().trim().equals("")) {
            Toast.makeText(TRegisterActivity.this, "密码不能为空!", Toast.LENGTH_LONG).show();
            return;
        }
        OkHttpUtils
                .post()
                .url(HttpUtil.TEACHERREGISTER)
                .addParams("id", newUsername.getText().toString().trim())
                .addParams("rank", newRank.getText().toString().trim())
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String arg0, int arg1) {
                        ...
                        if (0 == userEntity.getCode()) {
                            ...
                            Intent intent = new Intent(TRegisterActivity.this, LoginActivity.class);
                            startActivity(intent);
