...
public class StQuekecishuActivity extends BaseActivity {
    ...
    public void chaxun2() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                int count=0;
                Toast.makeText(StQuekecishuActivity.this,"222", Toast.LENGTH_SHORT).show();
                try{
                    Class.forName(CLS);
                    ...
                    Toast.makeText(StQuekecishuActivity.this,"333", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                    Toast.makeText(StQuekecishuActivity.this,"444", Toast.LENGTH_SHORT).show();
                }
    ...
    public void chaxun() {
        ...
        OkHttpUtils
                .post()
                .url(HttpUtil.St_Quekecishu)//传递课程名和学号
                .addParams("course_name", course_name.getText().toString().trim())
                .addParams("studentId", Static.studentId)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String arg0, int arg1) {
                        ...
                        if (0==userEntity.getCode()) {//成功
                            z=userEntity.getMsg();
                            result.setText(z);
                            Toast.makeText(StQuekecishuActivity.this, "查询成功", Toast.LENGTH_SHORT).show();

                        } else {
                            Toast.makeText(StQuekecishuActivity.this, userEntity.getMsg(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onError(Call arg0, Exception arg1, int arg2) {
                        Toast.makeText(StQuekecishuActivity.this, "网络错误", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public int getLayoutRes() {
        return R.layout.activity_st_quekecishu;
    }
